...
CREATE TABLE "CopperConcentration" (
    ...
    "copConDate" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Flow" (
    "id" SERIAL NOT NULL,
    "hipName" TEXT NOT NULL,
    "flowDataIntDate" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "PiezometerAcid" (
    ...
    "piezometerDate" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "WellWaterLevel" (
    "id" SERIAL NOT NULL,
    "hipName" TEXT NOT NULL,
    "wellLevelDate" TIMESTAMP(3) NOT NULL,
